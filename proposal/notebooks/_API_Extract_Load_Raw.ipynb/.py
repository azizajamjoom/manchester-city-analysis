...
# Save match data locally and to PostgreSQL
...
matches_df.to_sql('raw_api_matches', engine, if_exists='replace', index=False)

print("✅ Match data loaded into PostgreSQL")
...
# Save player data locally and to PostgreSQL
players_df.to_csv("raw_api_players.csv", index=False)
players_df.to_sql('raw_api_players', engine, if_exists='replace', index=False)

print("✅ Player data loaded into PostgreSQL")
